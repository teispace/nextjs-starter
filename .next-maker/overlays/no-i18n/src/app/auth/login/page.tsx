...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Sign in',
  description: 'This is a placeholder sign-in page. Replace it with your authentication flow.',
  path: '/auth/login',
  noIndex: true,
});
...
async function ReturnNotice({
  ...
  return (
    <p className="text-gray-500 text-sm dark:text-gray-400">
      After signing in you will be sent back to {redirectTo}.
    </p>
  );
}
...
export default function LoginPage({ searchParams }: PageProps<'/auth/login'>) {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center px-4 text-center">
      <h1 className="mb-2 font-bold text-2xl text-gray-900 dark:text-gray-100">Sign in</h1>
      <p className="mb-4 max-w-md text-gray-500 dark:text-gray-400">
        This is a placeholder sign-in page. Replace it with your authentication flow.
      </p>
